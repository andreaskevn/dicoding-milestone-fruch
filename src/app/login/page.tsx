    ...
    <>
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-emerald-100 via-teal-50 to-cyan-100 px-4 py-8 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* Geometric Shapes */}
          <div className="absolute top-20 left-20 w-16 h-16 border-2 border-indigo-300/30 rotate-45 animate-spin-slow"></div>
          <div className="absolute bottom-20 right-20 w-12 h-12 bg-gradient-to-r from-purple-300/20 to-pink-300/20 rounded-full animate-pulse"></div>
          <div className="absolute top-1/2 left-10 w-8 h-8 bg-blue-300/20 transform rotate-45 animate-bounce-slow"></div>
        </div>

        {/* Main Content */}
        <div className="relative z-10 p-8 backdrop-blur-md bg-white/30 shadow-2xl rounded-xl w-full max-w-md transform transition-all hover:scale-[1.02] duration-300">
          <div className="text-center mb-8">
            <div className="inline-block text-indigo-600 hover:text-indigo-800 transition-colors">
              <Image src="/logo.png" alt="Fruch Logo" width={80} height={80} />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
              <div
                className="bg-red-50 border-l-4 border-red-500 p-4 rounded-md animate-shake"
                role="alert"
              >
                <div className="flex">
          ...
          <p className="mt-8 text-center text-sm text-gray-600 animate-fade-in-delay-2">
            ...
            <Link
              href="/register"
              className="font-medium text-indigo-600 hover:text-indigo-500 hover:underline transition-all duration-200 hover:scale-105 inline-block"
            >
              Daftar di sini
            </Link>
          </p>
        ...
        <div className="relative z-10 mt-8 text-center transform transition-all hover:scale-105 duration-300 ease-in-out animate-slide-up-delay-3">
          <button>
            <Link
              href={"/"}
