        ...
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-8 md:mb-0">
            <div className="flex items-center gap-2 mb-4">
              <Image src="/logo.png" alt="Fruch Logo" width={32} height={32} />
              <h3 className="text-xl font-bold text-white">Fruch</h3>
            </div>
            <p className="text-emerald-200 max-w-xs">
              Aplikasi pengecekan tingkat kematangan buah dan informasi manfaat
              kesehatan menggunakan teknologi AI.
            </p>
          </div>
